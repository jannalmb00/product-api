...
INSERT INTO `categories` (`category_id`, `category_name`, `category_description`, `parent_category_id`, `category_type`, `category_level`, `category_tags`) VALUES
...
INSERT INTO `environmentals` (`environmental_id`, `product_id`, `packaging_name`, `eco_score`, `transportation_score`, `fromPalmOil`, `recycling_info`) VALUES
...
INSERT INTO `nutritions` (`nutritional_id`, `energy`, `fat`, `saturated_fat`, `protein`, `carbs`, `sodium`, `sugar`, `nova_group`) VALUES
...
INSERT INTO `products` (`product_id`, `product_name`, `product_barcode`, `product_origin`, `product_serving_size`, `product_image`, `nutrition_id`, `diet_id`, `brand_id`, `category_id`, `environmental_id`) VALUES
