...
--
ALTER TABLE `categories`
  ADD CONSTRAINT `category_ibfk_1` FOREIGN KEY (`parent_category_id`) REFERENCES `categories` (`category_id`) ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE `products`
  ...
  ADD CONSTRAINT `product_ibfk_3` FOREIGN KEY (`nutrition_id`) REFERENCES `nutritions` (`nutritional_id`) ON DELETE SET NULL ON UPDATE NO ACTION,
  ADD CONSTRAINT `product_ibfk_4` FOREIGN KEY (`environmental_id`) REFERENCES `environmentals` (`environmental_id`) ON DELETE SET NULL ON UPDATE NO ACTION,
  ADD CONSTRAINT `product_ibfk_5` FOREIGN KEY (`category_id`) REFERENCES `categories` (`category_id`) ON DELETE SET NULL ON UPDATE NO ACTION;
